...
export const PresentationControls: React.FC<PresentationControlsProps> = ({
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-6 left-1/2 -translate-x-1/2 z-50 flex items-center gap-4 px-4 py-2 rounded-full bg-[#0a0d14]/90 border border-white/10 shadow-[0_15px_35px_rgba(0,0,0,0.8)] backdrop-blur-md transition-opacity duration-700 select-none ${
      ...
      >
        ...
        >
          {isPaused ? (
            <svg className="w-4 h-4 text-[#c5a869]" fill="currentColor" viewBox="0 0 20 20">
        ...
        <button
          ...
          className={`text-[10px] font-mono tracking-widest uppercase transition-colors ${
            phase === 'INTRO' ? 'text-[#c5a869] font-medium' : 'text-white/40 hover:text-white'
          }`}
        >
          Intro
        </button>
        <button
          ...
          className={`text-[10px] font-mono tracking-widest uppercase transition-colors ${
            phase === 'ELEVATION_REVEAL' ? 'text-[#c5a869] font-medium' : 'text-white/40 hover:text-white'
          }`}
        >
          Elevation
        </button>
        ...
        <button
          ...
          className={`text-[10px] font-mono tracking-widest uppercase transition-colors ${
            phase === 'SUMMARY' ? 'text-[#c5a869] font-medium' : 'text-white/40 hover:text-white'
          }`}
        >
          Summary
        </button>
